...
from hooking_streams import get_loose_goal_gen, get_hook_initial_test, get_hooking_gen
...
if __name__ == '__main__':
    ...
    scenario.reset()
    scenario.add_robot()
    scenario.add_cube(((0.9, 0.3, 0.025), (0,0,0,1)))
    scenario.add_hook()
    scenario.add_hook_mark()
    scenario.add_goal_surface()
    ...
    #################################################
    # Solve the problem
    solver = Solver(scenario.panda, movable=[scenario.cube, scenario.hook], tools=[scenario.hook], surfaces=[scenario.goal_surface, scenario.hook_mark], marks=[scenario.hook_mark])
