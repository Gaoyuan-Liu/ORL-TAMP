...
from neuro_generators import get_loose_goal_hook_gen, get_loose_goal_push_gen, get_push_initial_test, get_hook_initial_test, get_same_surface_test
...
class Solver():
    def __init__(self, robot, movable=[], tools=[], surfaces=[0], obstacles=[], marks=[], top_grasps=[], edge_grasps=[]):
    ...
    def pddlstream_from_problem(self, collisions=True, teleport=False):
        ...
        stream_map = {
            ...
            'test-hook-initial-pose': from_test(get_hook_initial_test(self.problem, collisions=collisions)),
