...
from neuro_generators import get_loose_goal_retrieve_gen, get_loose_goal_push_gen, get_push_initial_test, get_retrieve_initial_test, get_same_surface_test
...
class Solver():
    ...
    def pddlstream_from_problem(self, collisions=True, teleport=False):
        ...
        stream_map = {
            ...
            'sample-loose-goal-retrieve': from_gen_fn(get_loose_goal_retrieve_gen(self.problem, collisions=collisions)),
