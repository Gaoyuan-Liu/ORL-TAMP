...
class Solver():
    ...
    def problem_formation(self):
        ...
        self.problem.top_grasps = self.movable
    ...
    def pddlstream_from_problem(self, collisions=True, teleport=False):
        ...
        stream_map = {
            ...
            'sample-loose-goal-retrieve': from_gen_fn(get_loose_goal_gen(self.problem, collisions=collisions)),
